...
public class Reverse {
    public static void main(String[] args) {
        ...
        // We cannot reverse the numbers without storing them that means we will need an array to do it
        ...
        //Jo bhi user input dega to us input k hisab se new array create hojaigi, means array will be equal to size of input
        int[] arr = new int[N];
        ...
        for(int i = 0; i < N; i++){
            ...
            //This will get the next integer in line from the CL and the loop will increment once the integer is entered
            arr[i] = sc.nextInt();  
        }

        //Ab jab array input agayi hai to run another loop but this time use i-- so that it prints from the last index i.e reverse
